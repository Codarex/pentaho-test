...
CREATE DATABASE hibernate WITH OWNER = tomcat ENCODING = 'UTF8' TABLESPACE = pg_default;

GRANT ALL PRIVILEGES ON DATABASE hibernate to tomcat;

--End--
--Begin Connect--

\connect hibernate tomcat
